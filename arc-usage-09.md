...
{{ARC-MULTI}} is adapting the output of the DCRUP working group [https://datatracker.ietf.org/wg/dcrup/about](https://datatracker.ietf.org/wg/dcrup/about) for use in ARC. It specifically covers how to create and validate ARC header sets and chains that include mutliple signature algorithms.
...
## How can an ARC Intermediary adopt a new digital signature algorithm that other Intermediaries and Validators may not support?
